...
# This Powershell script was designed following my attendance at SANS 504 to implement
# methods of discovery within a network to provide a quick synopsis of machines in question.
